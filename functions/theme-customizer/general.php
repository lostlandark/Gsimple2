...
function wpex_customizer_general($wp_customize) {
	...
	$wp_customize->add_setting( 'wpex_copyright', array(
		'type'		=> 'theme_mod',
		'default'	=> 'Blogger <a href=\"http://www.wordpress.org\" title="WordPress" target="_blank">WordPress</a> Theme Designed &amp; Developed by <a href=\"http://themeforest.net/user/WPExplorer?ref=WPExplorer" target="_blank" title="WPExplorer">WPExplorer</a>',
	) );
